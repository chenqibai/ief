...
public class BaiduAddressUtil {
    private static final String BAIDU_GET_DIS= "http://api.map.baidu.com/geocoder/v2/?ak=F7f4e9ffd4170d51d05ffe0e69478e3e&callback=renderReverse&output=json&pois=1&location=";
...
//        System.out.println(getCityAndDistrict(text));
        System.out.println("###" + BaiduAddressUtil.getCityAndDistrict("39.983424", "116.322987"));
        //11
        //7
    }
}
